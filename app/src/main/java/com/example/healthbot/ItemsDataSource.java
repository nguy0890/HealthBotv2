...
public class ItemsDataSource {
    ...
    private String[] columns = {MySQLiteProfile.User_ID,
            MySQLiteProfile.USER_NAME, MySQLiteProfile.USER_GENDER, MySQLiteProfile.USER_AGE};
    ...
    public User createItem(User item) {
        ...
        values.put(MySQLiteProfile.USER_AGE, item.getAge());
    ...
    public User updateItem(String item, int id, int gender, int age) {
        ...
        values.put(MySQLiteProfile.USER_AGE, age);
